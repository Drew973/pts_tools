...
from pts_tools.vcs.defect import defect,fields
...
class vcsToGisAlg(QgsProcessingFeatureBasedAlgorithm):
    ...
    def initParameters(self, config):
        #delimited text fields treated as str until loaded into QGIS.
         ...
         self.addParameter(QgsProcessingParameterField('width', 'Field with width' , parentLayerParameterName='INPUT',defaultValue='width'))
         self.addParameter(QgsProcessingParameterField('photo', 'Field with photo' , parentLayerParameterName='INPUT',defaultValue='photo'))
    ...
    def prepareAlgorithm(self,parameters,context,feedback):
        ...
        self.photoField = self.field('photo',parameters,context)
    ...
    def featureToDefect(self,feature):
        return defect(sec = feature[self.secField],
               ...
               photo = feature[self.photoField],
               width = feature[self.widthField])
